...
$q1 = "INSERT INTO workers (name, location, mobile, Email, address, services, experiance, rating, pass, photo)
			 VALUES ('$name','$location','$mobile','$email','$address','$services','$experiance',0,'$pass','$photo')";
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="location" id="location"
                           placeholder="Enter location Eg : Chowrastha" value="" required>
                ...
                <div class="form-group">
                    <label for="addservices">
                        Service Type
                           ...
                           <select class="form-control" name="services" id="addservices">
