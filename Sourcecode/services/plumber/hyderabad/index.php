...
$q1="SELECT * FROM workers where services='Plumber' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Plumber">
    <title>Plumber Services | My Town Home-Services Plumber Services</title>
...
<section id="main-slider" class="slider">
    ...
    <div class="flexslider">
      <ul class="slides">
              ...
              <li>
                <img src="../../../main-slider/ramukaka-10.jpg" alt="My Town Home-Services Technician"/>
...
<section id="services">
    <div class="service-header">
        <h1 class="text-center">Plumber in Hyderabad</h1>
