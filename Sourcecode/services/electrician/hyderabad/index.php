...
$q1="SELECT * FROM workers where services='Electrician' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Electrician">
    <title>Electrician Services | My Town Home-Services Electrician Services</title>
...
<section id="main-slider" class="slider">
    ...
    <div class="flexslider">
      <ul class="slides">
              ...
              <li>
                <img src="../../../main-slider/ramukaka-11.jpg" alt="My Town Home-Services Technician"/>
...
<section id="services">
    <div class="service-header">
        <h1 class="text-center">Electrician in Hyderabad</h1>
