...
$q1="SELECT * FROM workers where services='House_Cleaning' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <title>House Cleaning Services | My Town Home-Services House Cleaning Services</title>
...
<section id="main-slider" class="slider">
    ...
    <div class="flexslider">
      <ul class="slides">
              ...
              <li>
                <img src="../../../main-slider/ramukaka-19.jpg" alt="My Town Home-Services Technician"/>
...
<section id="services">
    <div class="service-header">
        <h1 class="text-center">House Cleaning in Hyderabad</h1>
