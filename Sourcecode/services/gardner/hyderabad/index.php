...
$q1="SELECT * FROM workers where services='Gardner' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Gardner">
    <title>Gardner Services | My Town Home-Services Gardner Services</title>
...
<section id="main-slider" class="slider">
    ...
    <div class="flexslider">
      <ul class="slides">
              ...
              <li>
                <img src="../../../main-slider/ramukaka-18.jpg" alt="My Town Home-Services Technician"/>
...
<section id="services">
    <div class="service-header">
        <h1 class="text-center">Gardner in Hyderabad</h1>
