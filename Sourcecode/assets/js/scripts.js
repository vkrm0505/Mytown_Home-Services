...
function sendOTPbyJS() {
    if ("" != $("#mobile").val() && 10 == $("#mobile").val().length && $.isNumeric($("#mobile").val())) {
        var a = $("#mobile").val();
        $.ajax({ url: CI_ROOT + "home/sendOTP", data: { mobile: a }, type: "POST", success: function (a) {} });
    } else alert("Please enter 10 digit mobile number");
}
...
+(function (a) {
    ...
    (function (a) {
        a(window).load(function () {
            a(".flexslider").flexslider({ animation: "slide", controlsContainer: a(".custom-controls-container"), customDirectionNav: a(".custom-navigation a") }),
    ...
    $(function () {
        $(".dropdown").hover(
            function () {
                $(".dropdown-menu", this).stop(!0, !0).fadeIn("fast"), $(this).addClass("open-menu");
            },
            function () {
                $(".dropdown-menu", this).stop(!0, !0).fadeOut("fast"), $(this).removeClass("open-menu");
            }
        );
    }),
    ...
    $(document).ready(function () {
        var a = $(window).height();
        700 > a && $(".flexslider .slides img").css({ "max-height": a - 110 + "px" }),
            $("#location1").on("focus click", function () {
                $("html, body").animate({ scrollTop: $("#location1").offset().top - 67 }, 500);
            }),
            $("#service_check_mobile").on("focus click", function () {
                $("html, body").animate({ scrollTop: $("#service_check_mobile").offset().top - 67 }, 500);
            }),
            $(".sp-mobile").on("click", function (a) {
                var b = $(document).width();
                b >= 480
                    ? ($("html, body").animate({ scrollTop: $("#main-searchWraper").offset().top - 67 }, 1e3),
                      $("#searchFrom").popover({ title: "Message", content: "Please complete this form to get contact details of suggested service providers.", placement: "bottom" }),
                      $("#searchFrom").popover("show"))
                    : ($("html, body").animate({ scrollTop: $(".mobile-form").offset().top - 67 }, 1e3),
                      $(".mobile-form").popover({ title: "Message", content: "Please complete this form to get contact details of suggested service providers.", placement: "bottom" }),
                      $(".mobile-form").popover("show"));
            }),
            $(".service-list-click").on("click", "li", function (a) {
                a.preventDefault(), localStorage.setItem("services", $(this).text()), $("#service_check").val($(this).text()), $("#service_check_mobile").val($(this).text());
                var b = $(document).width();
                b >= 480
                    ? ($("html, body").animate({ scrollTop: $("#main-searchWraper").offset().top - 67 }, 1e3),
                      $("#searchFrom").popover({ title: "Hurray!", content: "Just tell us your location and mobile no to get service provider details", placement: "bottom" }),
                      $("#searchFrom").popover("show"))
                    : ($("html, body").animate({ scrollTop: $(".mobile-form").offset().top - 67 }, 1e3),
                      $(".mobile-form").popover({ title: "Hurray!", content: "Just tell us your location and mobile no to get service provider details", placement: "bottom" }),
                      $(".mobile-form").popover("show"));
            }),
        ...
        var b = { bounds: new google.maps.Circle({ center: new google.maps.LatLng(17.424676, 78.403688), radius: 500 }).getBounds(), componentRestrictions: { country: "in" } },
            c = document.getElementById("location"),
            d = (new google.maps.places.Autocomplete(c, b), document.getElementById("location1")),
            e = (new google.maps.places.Autocomplete(d, b), document.getElementById("location2"));
        new google.maps.places.Autocomplete(e, b);
    });
var __slice = [].slice;
!(function (a, b) {
    var c;
    ...
    $(function () {
        !(function (a, b, c) {
            ...
            a.getElementById(c) || ((d = a.createElement(b)), (d.id = c), (d.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=334364413255377&version=v2.0"), e.parentNode.insertBefore(d, e));
...
$(function () {
    ...
    $("#sendLoginOTP").on("click", function (a) {
        if ("" != $("#mobile").val() && 10 == $("#mobile").val().length && $.isNumeric($("#mobile").val())) {
            $("#sendLoginOTP").toggleClass("hidden"), $("#otp").toggleClass("hidden");
            ...
            $.ajax({
                ...
                success: function (a, b) {
                    "success" == b || alert("Error while generating OTP");
                },
            });
        } else alert("Please enter 10 digit mobile number");
    }),
    ...
    $("#desktop_form").on("click", function () {
        var a = $.trim($("#location").val()),
            ...
            c = $.trim($("#mob").val());
        if ("" == b || (!checkServiceInCache("desktop") && localStorage.getItem("services") !== $("#service_check").val())) alert("Please select a service from auto-complete box only!");
        else if ("" != c && 10 == c.length && $.isNumeric(c))
            if ("" != a) {
            ...
            } else alert("Location cannot be empty!");
        else alert("Please enter 10 digit mobile number");
    }),
    $("#mobile_form").on("click", function () {
        var a = $.trim($("#location1").val()),
            ...
            c = $.trim($("#mob1").val());
        if ("" == b || (!checkServiceInCache("mobile") && localStorage.getItem("services") !== $("#service_check_mobile").val())) alert("Please select a service from auto-complete box only!");
        else if ("" != c && 10 == c.length && $.isNumeric(c))
            if ("" != a) {
                $("#mobile-search-form").toggleClass("hidden"), $("#mobile-otp-form").toggleClass("hidden"), $("#cust_otp1").focus();
                var d = CI_ROOT + "services/generateUserOTP";
                $.ajax({
                    url: d,
                    data: { mobile: c, service: b, location: a },
    ...
    $("#goBack_mobile").on("click", function () {
        $("#mobile-search-form").toggleClass("hidden"), $("#mobile-otp-form").toggleClass("hidden");
    });
