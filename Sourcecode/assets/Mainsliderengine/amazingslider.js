...
(function ($) {
    $.fn.html5lightbox = function (options) {
        ...
        inst.options = jQuery.extend({
            ...
            titlecss: "{color:#333333; font-size:16px; font-family:Armata,sans-serif,Arial; overflow:hidden;}",
            errorwidth: 280,
            errorheight: 48,
    ...
    $.fn.amazingslider = function (options) {
        ...
        AmazingSlider.prototype = {
            ...
            initHtml5Lightbox: function () {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    for (i = 0; i < this.lightboxArray.length; i++) this.html5Lightbox.addItem(this.lightboxArray[i][ELEM_LINK], this.lightboxArray[i][ELEM_TITLE], "amazingslider" + this.id, this.lightboxArray[i][ELEM_LIGHTBOXWIDTH],
            ...
            createWm: function () {
                ...
                else if (this.options.watermarkstyle == "image") html += "<img src='" + this.options.skinsfolder + this.options.watermarkimage +
                    "' style='border:none;' />";
            ...
            createText: function () {
                if (!this.options.showtext || this.options.textstyle == "none") return;
                var instance = this;
                        ...
                        if (!instance.elemArray[cur][ELEM_TITLE] && !instance.elemArray[cur][ELEM_DESCRIPTION]) $textWrapper.fadeOut();
                            ...
                            switch (pos) {
                                ...
                                case "topright":
                                    ...
                                    $textWrapper.css({
                                        margin: instance.options.textpositionmargintop + "px " + instance.options.textpositionmarginright +
                                            "px"
                                    });
                                    break;
                                case "bottomleft":
            ...
            createStyle: function () {
                ...
                if (this.options.navstyle == "thumbnails" && this.options.navthumbstyle != "imageonly") {
                    ...
                    if (this.options.navthumbstyle == "imageandtitledescription") styleCss += ".amazingslider-nav-thumbnail-description-" + this.id +
            ...
            createNav: function () {
                ...
                if (this.options.navstyle == "thumbnails" && this.options.navshowfeaturedarrow) {
                    bulletSize += this.options.navdirection ==
                        "vertical" ? this.options.navfeaturedarrowimagewidth : this.options.navfeaturedarrowimageheight;
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function (e) {
                    ...
                    else if (instance.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() || instance.options.navdirection == "horizontal" && $bulletWrapper.width() >
                        $navContainer.width()) {
                        ...
                        if (instance.options.navdirection == "vertical") $navContainer.css({
                            "margin-top": m + "px",
                            "margin-bottom": m + "px",
                            overflow: "hidden"
                        });
                        ...
                        var p = instance.options.navdirection == "vertical" ? instance.options.navwidth /
                            2 - instance.options.navthumbnavigationarrowimagewidth / 2 : instance.options.navheight / 2 - instance.options.navthumbnavigationarrowimageheight / 2;
                    ...
                    this.container.bind("amazingslider.switch", function (event, prev, cur) {
                        $(".amazingslider-bullet-" + instance.id + "-" + prev, instance.container)["bulletNormal" +
                            instance.id]();
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        var $previewArrow = $("<div class='amazingslider-nav-preview-arrow-" +
                            this.id + "' style='display:block;position:absolute;width:" + this.options.navpreviewarrowwidth + "px;height:" + this.options.navpreviewarrowheight + "px;" + 'background:url("' + this.options.skinsfolder + this.options.navpreviewarrowimage + "\") no-repeat center center;' ></div>");
                        switch (this.options.navpreviewposition) {
                            ...
                            case "top":
                                $previewArrow.css({
                                    ...
                                    top: "100%",
                                    "margin-left": "-" +
                                        Math.round(this.options.navpreviewarrowwidth / 2) + "px"
                                });
                                break;
                            case "left":
                                $previewArrow.css({
            ...
            createNavBullet: function (index) {
                ...
                $bullet.hover(function () {
                    ...
                    if (instance.options.navshowpreview) {
                        ...
                        var $nav =
                            $(".amazingslider-nav-" + instance.id, instance.container);
                        ...
                        var t, l = pos.left + instance.options.navwidth / 2 - instance.options.navpreviewwidth /
                        ...
                        switch (instance.options.navpreviewposition) {
                            ...
                            case "left":
                                lv =
                                    pos.left - instance.options.navpreviewwidth - 2 * instance.options.navpreviewborder - instance.options.navpreviewarrowwidth;
                                p = {
                                    left: lv + "px",
                                    top: tv + "px"
                                };
                        ...
                        $(imgLoader).load(function () {
                            var style;
                            if (this.width / this.height <= instance.options.navpreviewwidth / instance.options.navpreviewheight) style = "width:" + instance.options.navpreviewwidth + "px;max-width:" + instance.options.navpreviewwidth +
                                "px;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navpreviewwidth / 2 - instance.options.navpreviewheight / 2) + "px;";
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $(imgLoader).load(function () {
                        ...
                        else style = "max-width:none !important;width:auto;height:100%;margin-left:-" + Math.floor(this.width / this.height * instance.options.navimageheight / 2 - instance.options.navimagewidth /
                            2) + "px";
                        ...
                        if (instance.options.navthumbstyle != "imageonly") {
                            ...
                            if (instance.options.navthumbstyle == "imageandtitle") thumbtitle += "margin-left:0px;margin-top:" + instance.options.navimageheight + "px;width:" + instance.options.navimagewidth +
                                "px;height:" + instance.options.navthumbtitleheight + "px;";
                            ...
                            if (instance.options.navthumbstyle == "imageandtitledescription") thumbtitle += "<div class='amazingslider-nav-thumbnail-description-" +
                                instance.id + "'>" + instance.elemArray[index][ELEM_DESCRIPTION] + "</div>";
                            thumbtitle += "</div>";
                        ...
                        if (instance.options.navshowfeaturedarrow) {
                            ...
                            if (instance.options.navdirection == "horizontal") {
                                ...
                                if (instance.options.navposition == "top" ||
                                    instance.options.navposition == "topleft" || instance.options.navposition == "topright") t = pos.top + instance.options.navheight;
            ...
            slideRun: function (index, playVideo) {
                ...
                if ((playVideo ||
                    this.options.autoplayvideo) && this.elemArray[this.curElem][ELEM_VIDEO].length > 0) this.playVideo(true);
                else {
            ...
            showImage: function (slideDirection) {
                ...
                $(imgLoader).load(function () {
                    ...
                    var $imgPrev = $(".amazingslider-img-" + instance.id,
                        instance.container);
                    ...
                    } if (Math.abs(instance.curImageMarginLeft) > 0) imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" +
                        instance.curImageMaxWidth + "%;height:100%;left:0%;top:0%;margin-left:" + instance.curImageMarginLeft + "%";
                    ...
                    var transitioneffect = instance.firstslide &&
                        !instance.options.transitiononfirstslide ? "" : instance.options.transition;
                    ...
                    var videoLightbox = instance.elemArray[instance.curElem][ELEM_LINK] && instance.elemArray[instance.curElem][ELEM_LIGHTBOX] &&
                        instance.checkVideoType(instance.elemArray[instance.curElem][ELEM_LINK]) > 0;
        ...
        this.each(function () {
            ...
            var defaultOptions = {
                ...
                wtextdefault: "",
                wimagedefault: "",
                wpositioncssdefault: "display:block;position:absolute;top:6px;left:6px;",
                wtextcssdefault: "font:0px Arial,Tahoma,Helvetica,sans-serif;color:#fff;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);",
            ...
            if (typeof amazingslider_previewmode !=
                "undefined") this.options.previewmode = amazingslider_previewmode;
            ...
            l = mark.length;
            for (i = 0; i < 5; i++) mark = mark.slice(0, l - 9 + i) + mark.slice(l - 8 +
                i);
